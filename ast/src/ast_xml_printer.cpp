...
ast_xml_printer::ast_xml_printer(std::ostream& os, bool write_header)
  : os_(os)
  , indent_(0)
{
  if (write_header)
...
bool
ast_xml_printer::visit(const hamfile& v)
{
  os_ << "<hamfile>\n";
...
bool
ast_xml_printer::visit(const rule_invocation& v)
{
...
bool
ast_xml_printer::visit(const list_of& v)
{
...
bool
ast_xml_printer::visit(const empty_expr& v)
{
...
bool
ast_xml_printer::visit(const id_expr& v)
{
...
bool
ast_xml_printer::visit(const named_expr& v)
{
...
bool
ast_xml_printer::visit(const path_like_seq& v)
{
  os_ << std::setw(indent_) << ' ' << "<path_like_seq value=\""
      << v.to_identifier() << "\"/>\n";
...
bool
ast_xml_printer::visit(const requirement_set& v)
{
...
bool
ast_xml_printer::visit(const error_expression& v)
{
...
bool
ast_xml_printer::visit(const simple_requirement& v)
{
  os_ << std::setw(indent_) << ' ' << "<simple_requirement public=\""
      << v.is_public() << "\">\n";
...
bool
ast_xml_printer::visit(const conditional_requirement& v)
{
  os_ << std::setw(indent_) << ' ' << "<conditional_requirement public=\""
      << v.is_public() << "\">\n";
...
bool
ast_xml_printer::visit(const target_ref& v)
{
  os_ << std::setw(indent_) << ' ' << "<target_ref public=\"" << v.is_public()
      << "\"\n";
  os_ << std::setw(indent_) << ' ' << "            head=\""
      << v.head()->to_identifier() << "\"\n";
...
bool
ast_xml_printer::visit(const feature& v)
{
...
bool
ast_xml_printer::visit(const sources_decl& v)
{
