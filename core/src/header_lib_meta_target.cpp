...
header_lib_meta_target::header_lib_meta_target(
  hammer::project* p,
...
void
header_lib_meta_target::instantiate_impl(const main_target* owner,
                                         const feature_set& build_request,
                                         std::vector<basic_target*>* result,
                                         feature_set* usage_requirements) const
{
  feature_set* build_request_for_sourses =
  ...
  // do
  feature_set& sources_as_features =
    *get_engine()->feature_registry().make_set();
  ...
  main_target* mt = new header_lib_main_target(
    this,
    name(),
  ...
  instantiate_simple_targets(
    simple_targets, *mt_fs, *mt, &instantiated_simple_targets);
