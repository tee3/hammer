...
static location_t
make_location(location_t::const_iterator first, location_t::const_iterator last)
{
  location_t result;
                              ...
                              global_project_links_t& symlink_storage)
{
  ...
  if (i != symlink_storage.end()) {
    ...
    if (symlinks.empty() && !i->second->aliases_data_.empty())
      symlinks.push_back(resolved_project_symlink_t(make_location(first, last),
...
engine::loaded_projects_t
engine::try_load_project(location_t project_path, const project& from_project)
{
  if (project_path.has_root_path()) {
    while (true) {
      ...
      for (resolved_project_symlinks_t::const_iterator i = symlinks.begin(),
           ...
           i != last;
           ++i)
        for (project_alias_node::aliases_data_t::const_iterator
               j = i->symlinks_data_->begin(),
...
{
  auto_ptr<basic_meta_target> mt(new lib_meta_target(
    p,
    name.at(0),
...
engine::searched_shared_lib_rule(project* p,
                                 ...
                                 requirements_decl* usage_requirements)
{
  auto_ptr<basic_meta_target> mt(new searched_lib_meta_target(
    p,
    name.at(0),
    lib_name,
    requirements ? *requirements : requirements_decl(),
...
engine::prebuilt_lib_rule(project* p,
                          ...
                          requirements_decl* usage_requirements)
{
  auto_ptr<basic_meta_target> mt(new prebuilt_lib_meta_target(
    p,
    name,
    lib_filename,
    requirements ? *requirements : requirements_decl(),
...
engine::file_rule(project* p,
                  ...
                  requirements_decl* usage_requirements)
{
  auto_ptr<basic_meta_target> mt(new file_meta_target(
    p,
    name.at(0),
    filename,
    requirements ? *requirements : requirements_decl(),
...
engine::header_lib_rule(project* p,
                        ...
                        requirements_decl* usage_requirements)
{
  auto_ptr<basic_meta_target> mt(new header_lib_meta_target(
    p,
    name.at(0),
    requirements ? *requirements : requirements_decl(),
    usage_requirements ? *usage_requirements : requirements_decl()));
...
engine::exe_rule(project* p,
                 ...
                 requirements_decl* usage_requirements)
{
  auto_ptr<basic_meta_target> mt(new typed_meta_target(
    p,
    name.at(0),
    requirements ? *requirements : requirements_decl(),
    usage_requirements ? *usage_requirements : requirements_decl(),
...
engine::obj_rule(project* p,
                 ...
                 requirements_decl* usage_requirements)
{
  auto_ptr<basic_meta_target> mt(new obj_meta_target(
    p,
    name,
    requirements ? *requirements : requirements_decl(),
    usage_requirements ? *usage_requirements : requirements_decl()));
...
engine::pch_rule(project* p,
                 ...
                 requirements_decl* usage_requirements)
{
  auto_ptr<basic_meta_target> mt(new pch_meta_target(
    p,
    name,
    requirements ? *requirements : requirements_decl(),
    usage_requirements ? *usage_requirements : requirements_decl()));
...
engine::copy_rule(project* p,
                  ...
                  requirements_decl* usage_requirements)
{
  auto_ptr<basic_meta_target> mt(new copy_meta_target(
    p,
    name,
    requirements ? *requirements : requirements_decl(),
    usage_requirements ? *usage_requirements : requirements_decl()));
                             ...
                             std::vector<std::string>* attributes)
{
  ...
  feature_registry_->add_feature_def(name[0],
                                     values ? *values
                           ...
                           std::vector<std::string>* attributes)
{
  ...
  p->local_feature_registry().add_feature_def(
    name[0],
    values ? *values : std::vector<std::string>(),
    resolve_attributes(attributes));
}

void
engine::feature_compose_rule(project* p, feature& f, feature_set& components)
{
...
engine::alias_rule(project* p,
                   ...
                   requirements_decl* usage_requirements)
{
  auto_ptr<basic_meta_target> mt(new alias_meta_target(
    p,
    name,
                        ...
                        sources_decl* propagated_sources)
{
  ...
  sources_decl& real_propagated_sources =
    (propagated_sources == NULL ? empty_source : *propagated_sources);
  ...
  for (sources_decl::iterator i = sources.begin(), last = sources.end();
       i != last;
       ++i)
                         ...
                         std::string* target_name)
{
  ...
  else if (sources != NULL && !sources->empty())
    real_target_name =
  ...
  auto_ptr<basic_meta_target> run_target(new testing_meta_target(
    p,
                                  ...
                                  requirements_decl* usage_requirements)
{
  const string target_name =
    location_t(sources.begin()->target_path()).stem().string();
  auto_ptr<basic_meta_target> mt(new testing_compile_fail_meta_target(
    p,
    target_name,
    requirements ? *requirements : requirements_decl(),
    usage_requirements ? *usage_requirements : requirements_decl()));
  ...
  const feature_set& build_request) const
{
  ...
  for (projects_t::const_iterator i = projects_.begin(), last = projects_.end();
       i != last;
       ++i) {
