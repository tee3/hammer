...
engine::engine()
  : feature_registry_(nullptr)
{
  unique_ptr<hammer::feature_registry> fr(new hammer::feature_registry());

  resolver_.insert("project",
                   boost::function<void(project*,
                                        vector<string>&,
                                        project_requirements_decl*,
                                        project_requirements_decl*)>(
                     boost::bind(&engine::project_rule, this, _1, _2, _3, _4)));
  resolver_.insert(
    "lib",
    boost::function<void(project*,
                         vector<string>&,
                         ...
                         feature_set*,
                         requirements_decl*)>(
      boost::bind(&engine::lib_rule, this, _1, _2, _3, _4, _5, _6)));
  resolver_.insert(
    "searched-shared-lib",
    boost::function<void(project*,
                         vector<string>&,
                         ...
                         requirements_decl*)>(
      boost::bind(
        &engine::searched_shared_lib_rule, this, _1, _2, _3, _4, _5, _6)));
  resolver_.insert(
    "searched-static-lib",
    boost::function<void(project*,
                         string&,
                         ...
                         requirements_decl*)>(
      boost::bind(
        &engine::searched_static_lib_rule, this, _1, _2, _3, _4, _5, _6)));
  resolver_.insert(
    "prebuilt-lib",
    boost::function<void(project*,
                         string&,
                         ...
                         requirements_decl*,
                         requirements_decl*)>(
      boost::bind(&engine::prebuilt_lib_rule, this, _1, _2, _3, _4, _5, _6)));
  resolver_.insert(
    "file",
    boost::function<void(project*,
                         vector<string>&,
                         ...
                         requirements_decl*,
                         requirements_decl*)>(
      boost::bind(&engine::file_rule, this, _1, _2, _3, _4, _5)));
  resolver_.insert(
    "header-lib",
    boost::function<void(project*,
                         vector<string>&,
                         ...
                         feature_set*,
                         requirements_decl*)>(
      boost::bind(&engine::header_lib_rule, this, _1, _2, _3, _4, _5, _6)));
  resolver_.insert(
    "exe",
    boost::function<void(project*,
                         vector<string>&,
                         ...
                         feature_set*,
                         requirements_decl*)>(
      boost::bind(&engine::exe_rule, this, _1, _2, _3, _4, _5, _6)));
  resolver_.insert(
    "obj",
    boost::function<void(project*,
                         string&,
                         ...
                         feature_set*,
                         requirements_decl*)>(
      boost::bind(&engine::obj_rule, this, _1, _2, _3, _4, _5, _6)));
  resolver_.insert(
    "pch",
    boost::function<void(project*,
                         string&,
                         ...
                         feature_set*,
                         requirements_decl*)>(
      boost::bind(&engine::pch_rule, this, _1, _2, _3, _4, _5, _6)));
  resolver_.insert(
    "copy",
    boost::function<void(project*,
                         string&,
                         ...
                         feature_set*,
                         requirements_decl*)>(
      boost::bind(&engine::copy_rule, this, _1, _2, _3, _4, _5, _6)));
  resolver_.insert(
    "alias",
    boost::function<void(project*,
                         string&,
                         ...
                         feature_set*,
                         requirements_decl*)>(
      boost::bind(&engine::alias_rule, this, _1, _2, _3, _4, _5, _6)));
  resolver_.insert(
    "version-alias",
    boost::function<void(project*, string&, string&, const string*)>(
      boost::bind(&engine::version_alias_rule, this, _1, _2, _3, _4)));
  resolver_.insert(
    "target-version-alias",
    boost::function<void(project*, string&, string&, const string*)>(
      boost::bind(&engine::target_version_alias_rule, this, _1, _2, _3, _4)));
  resolver_.insert(
    "test-suite",
    boost::function<void(project*, string&, sources_decl&, sources_decl*)>(
      boost::bind(&engine::test_suite_rule, this, _1, _2, _3, _4)));
  resolver_.insert(
    "testing.run",
    boost::function<sources_decl(project*,
                                 sources_decl*,
                                 std::vector<string>*,
                                 std::vector<string>*,
                                 requirements_decl*,
                                 string*)>(
      boost::bind(&engine::testing_run_rule, this, _1, _2, _3, _4, _5, _6)));
  resolver_.insert(
    ...
    boost::function<sources_decl(project*,
                                 ...
                                 requirements_decl*)>(
      boost::bind(
        &engine::testing_compile_fail_rule, this, _1, _2, _3, _4, _5)));
  resolver_.insert("import",
                   boost::function<void(project*, vector<string>&)>(
                     boost::bind(&engine::import_rule, this, _1, _2)));
  resolver_.insert(
    "feature.feature",
    boost::function<void(
      project*, vector<string>&, vector<string>*, vector<string>*)>(
      boost::bind(&engine::feature_feature_rule, this, _1, _2, _3, _4)));
  resolver_.insert(
    "feature.subfeature",
    boost::function<void(project*, string&, string&)>(
      boost::bind(&engine::feature_subfeature_rule, this, _1, _2, _3)));
  resolver_.insert(
    "feature.local",
    boost::function<void(
      project*, vector<string>&, vector<string>*, vector<string>*)>(
      boost::bind(&engine::feature_local_rule, this, _1, _2, _3, _4)));
  resolver_.insert(
    "feature.compose",
    boost::function<void(project*, feature&, feature_set&)>(
      boost::bind(&engine::feature_compose_rule, this, _1, _2, _3)));
  resolver_.insert(
    "variant",
    boost::function<void(project*, string&, string*, feature_set&)>(
      boost::bind(&engine::variant_rule, this, _1, _2, _3, _4)));
  resolver_.insert("glob",
                   boost::function<sources_decl(
                     project*, std::vector<string>&, std::vector<string>*)>(
                     boost::bind(&engine::glob_rule, this, _1, _2, _3, false)));
  resolver_.insert("rglob",
                   boost::function<sources_decl(
                     project*, std::vector<string>&, std::vector<string>*)>(
                     boost::bind(&engine::glob_rule, this, _1, _2, _3, true)));
  resolver_.insert("explicit",
                   boost::function<void(project*, const string&)>(
                     boost::bind(&engine::explicit_rule, this, _1, _2)));
  resolver_.insert(
    "use-project",
    boost::function<void(project*, const string&, const string&, feature_set*)>(
      boost::bind(&engine::use_project_rule, this, _1, _2, _3, _4)));
  resolver_.insert(
    "setup-warehouse",
    boost::function<void(
      project*, const string&, const string&, const string*)>(
      boost::bind(&engine::setup_warehouse_rule, this, _1, _2, _3, _4)));
  ...
  {
    // used to mark targets that belong to pch meta target. Needed for
    // distinguishing PCH and OBJ generators
    feature_attributes ft = { 0 };
    ft.free = 1;
...
{
  // FIXME: BUG: boost parent_path() on "foo/bar/.  produce "foo/bar" instead of
  // "foo"
  location_t upper_path = project_path.filename() == "."
                            ? project_path.parent_path().parent_path()
                            : project_path.parent_path();
  // FIXME: BUG: boost parent_path() can produce "E:" path and than "E:" / "foo"
  // give as "E:foo" which is wrong
...
static location_t
make_location(location_t::const_iterator first,
...
void
engine::resolve_project_alias(resolved_project_symlinks_t& symlinks,
                              ...
                              global_project_links_t& symlink_storage)
{
  ...
  if (i != symlink_storage.end()) {
    ...
    if (symlinks.empty() && !i->second->aliases_data_.empty()) {
      symlinks.emplace_back(make_location(first, last),
                            i->second->aliases_data_);
    }
  }
}
...
{
  // ���������� ��������� ����
  resolve_project_alias(symlinks,
                        ++project_symlink.begin(),
                        project_symlink.end(),
                        global_project_links_);
}

engine::loaded_projects_t
engine::load_project(location_t project_path, const project& from_project)
{
  try {
    loaded_projects_t result(try_load_project(project_path, from_project));
    if (result.empty()) {
      throw std::runtime_error(
        (boost::format("%s(0): error: can't load project '%s'") %
         from_project.location().string() % project_path)
          .str());
    }
    return result;
...
engine::loaded_projects_t
engine::try_load_project(const location_t& project_path,
                         const project& from_project)
{
  if (project_path.has_root_path()) {
    while (true) {
      ...
      for (resolved_project_symlinks_t::const_iterator i = symlinks.begin(),
                                                       last = symlinks.end();
           i != last;
           ++i) {
        for (auto j = i->symlinks_data_->begin(),
                  j_last = i->symlinks_data_->end();
             j != j_last;
             ++j) {
      ...
      if (warehouse_ && warehouse_->has_project(project_path, string())) {
        // If we can find project in warehouse than we need to add alternatives
        // to resulting set of projects
        ...
        if (materialized_warehouse_project == nullptr) {
          boost::shared_ptr<project> not_yet_materialized_versions =
            warehouse_->load_project(*this, project_path);
          // we need to check if we already inserted this project before. When
          // we doing warehouse::download_and_install we check
          // if project knows to engine and that trigger loading project again,
          // but engine may already manadge this project loaded before
          auto i = projects_.find(not_yet_materialized_versions->location());
          if (i == projects_.end()) {
            // FIXME: Maybe we shouldn't add warehouse projects into engine, and
            // manages them by warehouse
            projects_.insert({ not_yet_materialized_versions->location(),
                               not_yet_materialized_versions });
    ...
    resolve_use_project(
      resolved_use_path, tail_path, from_project, project_path);
...
void
engine::resolve_use_project(location_t& resolved_use_path,
                            ...
                            const location_t& path_to_resolve)
{
  ...
  use_project_data_t::mapped_type::const_iterator largets_use_iter =
    i->second.find(*path_to_resolve.begin());
  ...
  for (; to_resolve_begin != to_resolve_end; ++to_resolve_begin) {
    ...
    use_project_data_t::mapped_type::const_iterator next_resolve_iter =
      i->second.find(to_resolve);
  ...
  // FIXME: stupid boost::filesystem::path can't be constructed from two
  // iterators
  for (; to_resolve_begin != to_resolve_end; ++to_resolve_begin) {
...
engine::load_project(const location_t& project_path)
{
  ...
  if (result.empty()) {
    throw runtime_error("Can't load project at '" + project_path.string() +
                        ": no such path.");
  }
...
void
engine::load_hammer_script(location_t filepath)
{
  filepath.normalize();
  if (!exists(filepath)) {
    return throw std::runtime_error("Hammer script '" + filepath.string() +
                                    "' doesn't exists.");
  }

  projects_t::iterator i = projects_.find(filepath);
  if (i != projects_.end()) {
    throw std::runtime_error("Hammer script '" + filepath.string() +
                             "' already loaded.");
  }
  ...
  try {
    ...
    if (!p.parse(filepath.string().c_str())) {
      throw runtime_error("Can't load script at '" + filepath.string() +
                          ": parser errors");
    }
...
void
engine::load_hammer_script(const string& script_body, const string& script_name)
{
  hammer_walker_context ctx;
  ...
  try {
    ...
    if (!p.parse_raw_script(script_body, script_name)) {
      throw runtime_error("Can't parse raw script '" + script_name +
                          "': parser errors");
    }
    ...
    delete ctx.project_;
    throw std::runtime_error("Failed to load '" + script_name +
                             "' raw script: " + e.what());
  }
}
...
engine::try_load_project(location_t project_path)
{
  ...
  try {
    ...
    if (!is_top_level) {
      if (upper_project != nullptr) {
        ctx.project_->requirements().insert_infront(
          upper_project->requirements());
        ctx.project_->usage_requirements().insert_infront(
          upper_project->usage_requirements());
      }
    } else {
...
find_root(const boost::filesystem::path& initial_path)
{
...
void
engine::project_rule(project* p,
                     std::vector<string>& name,
                     project_requirements_decl* req,
                     project_requirements_decl* usage_req)
{
...
{
  unique_ptr<basic_meta_target> mt(new lib_meta_target(
    p,
    name.at(0),
...
void
engine::searched_shared_lib_rule(project* p,
                                 ...
                                 requirements_decl* usage_requirements)
{
  unique_ptr<basic_meta_target> mt(new searched_lib_meta_target(
    p,
    name.at(0),
    lib_name,
    requirements != nullptr ? *requirements : requirements_decl(),
...
void
engine::searched_static_lib_rule(project* p,
                                 std::string& name,
                                 sources_decl* sources,
                                 std::string& lib_name,
                                 requirements_decl* requirements,
...
void
engine::prebuilt_lib_rule(project* p,
                          std::string& name,
                          sources_decl* sources,
                          ...
                          requirements_decl* usage_requirements)
{
  unique_ptr<basic_meta_target> mt(new prebuilt_lib_meta_target(
    p,
    name,
    lib_filename,
    requirements != nullptr ? *requirements : requirements_decl(),
...
void
engine::file_rule(project* p,
                  std::vector<std::string>& name,
                  std::string& filename,
                  requirements_decl* requirements,
                  requirements_decl* usage_requirements)
{
  unique_ptr<basic_meta_target> mt(new file_meta_target(
    p,
    name.at(0),
    filename,
    requirements != nullptr ? *requirements : requirements_decl(),
...
void
engine::header_lib_rule(project* p,
                        std::vector<std::string>& name,
                        sources_decl* sources,
                        requirements_decl* requirements,
                        feature_set* /*default_build*/,
                        requirements_decl* usage_requirements)
{
  unique_ptr<basic_meta_target> mt(new header_lib_meta_target(
    p,
    name.at(0),
    requirements != nullptr ? *requirements : requirements_decl(),
    usage_requirements != nullptr ? *usage_requirements : requirements_decl()));
...
engine::exe_rule(project* p,
                 ...
                 requirements_decl* usage_requirements)
{
  unique_ptr<basic_meta_target> mt(new typed_meta_target(
    p,
    name.at(0),
    requirements != nullptr ? *requirements : requirements_decl(),
    usage_requirements != nullptr ? *usage_requirements : requirements_decl(),
...
engine::obj_rule(project* p,
                 ...
                 requirements_decl* usage_requirements)
{
  unique_ptr<basic_meta_target> mt(new obj_meta_target(
    p,
    name,
    requirements != nullptr ? *requirements : requirements_decl(),
    usage_requirements != nullptr ? *usage_requirements : requirements_decl()));
...
engine::pch_rule(project* p,
                 ...
                 requirements_decl* usage_requirements)
{
  unique_ptr<basic_meta_target> mt(new pch_meta_target(
    p,
    name,
    requirements != nullptr ? *requirements : requirements_decl(),
    usage_requirements != nullptr ? *usage_requirements : requirements_decl()));
...
engine::copy_rule(project* p,
                  ...
                  requirements_decl* usage_requirements)
{
  unique_ptr<basic_meta_target> mt(new copy_meta_target(
    p,
    name,
    requirements != nullptr ? *requirements : requirements_decl(),
    usage_requirements != nullptr ? *usage_requirements : requirements_decl()));
...
void
engine::import_rule(project* /*p*/, std::vector<std::string>& /*name*/)
{
}

static feature_attributes
resolve_attributes(std::vector<std::string>* attributes)
{
...
void
engine::feature_feature_rule(project* /*p*/,
                             std::vector<std::string>& name,
                             ...
                             std::vector<std::string>* attributes)
{
  ...
  feature_registry_->add_feature_def(
    name[0],
    values != nullptr ? *values : std::vector<std::string>(),
    resolve_attributes(attributes));
}

void
engine::feature_subfeature_rule(project* /*p*/,
...
void
engine::feature_local_rule(project* p,
                           std::vector<std::string>& name,
                           std::vector<std::string>* values,
                           std::vector<std::string>* attributes)
{
  ...
  p->local_feature_registry().add_feature_def(
    name[0],
    values != nullptr ? *values : std::vector<std::string>(),
    resolve_attributes(attributes));
}
...
void
engine::feature_compose_rule(project* /*p*/,
                             feature& f,
...
engine::alias_rule(project* p,
                   ...
                   requirements_decl* usage_requirements)
{
  unique_ptr<basic_meta_target> mt(new alias_meta_target(
    p,
    name,
    sources == nullptr ? sources_decl() : *sources,
    requirements != nullptr ? *requirements : requirements_decl(),
    usage_requirements != nullptr ? *usage_requirements : requirements_decl()));
  p->add_target(std::move(mt));
}
...
void
engine::version_alias_rule(project* p,
                           std::string& name,
                           std::string& version,
                           const std::string* target_path)
{
  unique_ptr<basic_meta_target> mt(
    new version_alias_meta_target(p, name, version, target_path));
  p->add_target(std::move(mt));
}

void
engine::target_version_alias_rule(project* p,
                                  std::string& name,
                                  std::string& version,
                                  const std::string* target_path)
{
  unique_ptr<basic_meta_target> mt(
    new target_version_alias_meta_target(p, name, version, target_path));
  p->add_target(std::move(mt));
}

void
engine::test_suite_rule(project* p,
                        std::string& name,
                        sources_decl& sources,
                        sources_decl* propagated_sources)
{
  sources_decl empty_source;
  sources_decl& real_propagated_sources =
    (propagated_sources == nullptr ? empty_source : *propagated_sources);
  feature_set* additional_sources_set = feature_registry_->make_set();
  for (sources_decl::const_iterator i = real_propagated_sources.begin(),
                                    last = real_propagated_sources.end();
       i != last;
       ++i) {
    feature* f =
      feature_registry_->create_feature("testing.additional-source", "");
    f->set_dependency_data(*i, p);
    additional_sources_set->join(f);
  }

  for (auto& source : sources) {
    if (source.properties() != nullptr) {
      source.properties()->join(*additional_sources_set);
    } else {
      source.properties(additional_sources_set);
    }
  }

  unique_ptr<basic_meta_target> mt(new alias_meta_target(
    p, name, sources, requirements_decl(), requirements_decl()));

  p->add_target(std::move(mt));
}

sources_decl
engine::testing_run_rule(project* p,
                         sources_decl* sources,
                         ...
                         std::string* target_name)
{
  ...
  unique_ptr<basic_meta_target> intermediate_exe(
    new testing_intermediate_meta_target(
      p,
      exe_name,
      requirements != nullptr ? *requirements : requirements_decl(),
      requirements_decl(),
  ...
  intermediate_exe->sources(sources == nullptr ? sources_decl() : *sources);
  intermediate_exe->set_explicit(true);

  p->add_target(std::move(intermediate_exe));

  requirements_decl run_requirements;

  if (input_files != nullptr) {
    for (vector<std::string>::const_iterator i = input_files->begin(),
                                             last = input_files->end();
         i != last;
         ++i) {
      run_requirements.add(
        *this->feature_registry().create_feature("testing.input-file", *i));
    }
  }

  if (args != nullptr) {
    for (vector<std::string>::const_iterator i = args->begin(),
                                             last = args->end();
         i != last;
         ++i) {
      run_requirements.add(
        *this->feature_registry().create_feature("testing.argument", *i));
    }
  }

  unique_ptr<basic_meta_target> run_target(new testing_meta_target(
    p,
  ...
  p->add_target(std::move(run_target));
                                  ...
                                  requirements_decl* usage_requirements)
{
  const string target_name =
    location_t(sources.begin()->target_path()).stem().string();
  unique_ptr<basic_meta_target> mt(new testing_compile_fail_meta_target(
    p,
    target_name,
    requirements != nullptr ? *requirements : requirements_decl(),
    usage_requirements != nullptr ? *usage_requirements : requirements_decl()));
  ...
  const source_decl compile_source(
    mt->name(),
    std::string(),
    nullptr /*to signal that this is meta target*/,
    nullptr);
...
glob_impl(sources_decl& result,
          ...
          engine& e)
{
  for (fs::directory_iterator i(searching_path),
       last = fs::directory_iterator();
       i != last;
       ++i) {
    if (!is_directory(*i) && wildcard.match(i->path().filename()) &&
        !(exceptions != nullptr &&
          find(exceptions->begin(),
               exceptions->end(),
               i->path().filename().string()) != exceptions->end())) {
      result.push_back((relative_path / i->path().filename()).string(),
                       e.get_type_registry());
    }
  }
}
...
static void
rglob_impl(sources_decl& result,
           const fs::path& searching_path,
...
{
  int level = 0;
  for (fs::recursive_directory_iterator i(searching_path),
                  ...
                  bool recursive)
{
  ...
  for (const std::string& pattern : patterns) {
    ...
    string::size_type separator_pos = pattern.find_last_of(R"(/\)", mask_pos);
    path relative_path(
      separator_pos == string::npos
        ? path()
        : path(pattern.begin(), pattern.begin() + separator_pos));
    path searching_path(p->location() / relative_path);
    boost::dos_wildcard wildcard(
      string(pattern.begin() + mask_pos, pattern.end()));
    if (recursive) {
      rglob_impl(
        result, searching_path, relative_path, wildcard, exceptions, *this);
    } else {
      glob_impl(
        result, searching_path, relative_path, wildcard, exceptions, *this);
    }
...
void
engine::explicit_rule(project* p, const std::string& target_name)
{
...
void
engine::use_project(const project& p,
                    const std::string& project_id_alias,
                    const location_t& project_location)
{
  use_project_rule(const_cast<project*>(&p),
                   project_id_alias,
...
void
engine::use_project_rule(project* p,
                         const std::string& project_id_alias,
                         ...
                         feature_set* props)
{
  ...
  if (!l.has_root_path()) {
    auto i = use_project_data_.find(p);
    if (i != use_project_data_.end()) {
      use_project_data_t::mapped_type::const_iterator j =
        i->second.find(project_location);
      if (j != i->second.end()) {
        throw std::runtime_error("alias '" + project_id_alias +
                                 "' already mapped to location '" + j->second +
                                 "'.");
      }
    }
    ...
    for (location_t::const_iterator i = ++l.begin(), last = l.end(); i != last;
         ++i) {
      ...
      if (alias_data_home == project_links_node->end()) {
        ...
        location_t tmp(*i);
        alias_data_home =
          project_links_node->insert(make_pair(tmp, node)).first;
    ...
    reversed_global_project_links_.insert(
      make_pair(alias_data.location_, alias_data));
  }
}

void
engine::setup_warehouse_rule(project* p,
                             ...
                             const std::string* storage_dir_)
{
  ...
  string storage_dir;
  if ((storage_dir_ != nullptr) && !storage_dir_->empty()) {
...
engine::loaded_projects_t::select_best_alternative(
  const feature_set& build_request) const
{
  ...
  for (auto i : projects_) {
    project::selected_targets_t targets(
      (*i).select_best_alternative(build_request));
    for (project::selected_targets_t::const_iterator t = targets.begin(),
                                                     t_last = targets.end();
         t != t_last;
         ++t) {
  ...
  // Check for targets with same name. They already have same symbolic names so
  // we should check names.
  sort(result.begin(),
       result.end(),
       [](const project::selected_target& lhs,
  ...
  for (; second != result.end();) {
    if (first->target_->name() == second->target_->name()) {
      stringstream s;
      dump_for_hash(s, build_request);
      throw std::runtime_error("Can't select best alternative for target '" +
                               first->target_->name() + "' from projects:\n"
                                                        "1) '" +
                               first->target_->location().string() + "' \n"
                                                                     "2) '" +
                               second->target_->location().string() +
                               "' \n"
                               "Build request: " +
                               s.str());
    } else {
  ...
  const feature_set& build_request) const
{
  project::selected_targets_t result;
  for (auto i : projects_) {
    project::selected_target st =
      (*i).try_select_best_alternative(target_name, build_request);
    if (st.target_ != nullptr) {
      result.push_back(st);
    }
  }
  ...
  if (result.empty()) {
    stringstream s;
    s << "Can't select best alternative for target '" + target_name +
           "' - no one founded. \n"
  ...
  sort(result.begin(),
       ...
       [](const project::selected_target& lhs,
          const project::selected_target& rhs) {
         return lhs.resolved_build_request_rank_ >
                rhs.resolved_build_request_rank_;
       });

  if (result[0].resolved_build_request_rank_ !=
      result[1].resolved_build_request_rank_) {
    return result.front();
  }
  stringstream s;
  dump_for_hash(s, build_request);
  throw std::runtime_error("Can't select best alternative for target '" +
                           result[0].target_->name() + "' from projects:\n"
                                                       "1) '" +
                           result[0].target_->location().string() + "' \n"
                                                                    "2) '" +
                           result[1].target_->location().string() +
                           "' \n"
                           "Build request: " +
                           s.str());
}
...
void
engine::output_location_strategy(
  boost::shared_ptr<hammer::output_location_strategy>& strategy)
{
  if (!strategy) {
    output_location_strategy_.reset(new default_output_location_strategy);
  } else {
