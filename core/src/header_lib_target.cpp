...
header_lib_target::header_lib_target(const main_target* mt,
...
header_lib_target::generate() const
{
  throw std::runtime_error(
    "[header_lib_target] Generate should not be invoked");
}

void
header_lib_target::timestamp_info_impl() const
{
