...
feature.feature destination : : path no - checks incidental no - defaults;
#for copy rule
feature.feature recursive : on off : optional no - defaults;
#for copy rule
feature.feature type - to - copy : : free no - defaults;
#for copy rule
...
feature.feature warnings - as - errors
  : off #do not fail the compilation if there are warnings
      on #fail the compilation if there are warnings : incidental propagated;
...
#x86 and x86 - 64
  i386 i486 i586 i686 pentium pentium -
  mmx pentiumpro pentium2 pentium3 pentium3m pentium -
  m pentium4 pentium4m prescott nocona k6 k6 -
  2 k6 -
  3 athlon athlon -
  tbird athlon -
  4 athlon -
  xp athlon -
  mp k8 opteron athlon64 athlon -
  fx winchip -
  c6 winchip2 c3 c3 -
  2
#ia64
...
#RS / 6000 & PowerPC
  401 403 405 405fp 440 440fp 505 601 602 603 603e 604 604e 620 630 740 7400 7450 750 801 821 823 860 970 8540 power -
  common ec603e g3 g4 g5 power power2 power3 power4 power5 powerpc powerpc64
...
feature.feature character - set : multi - byte unicode unknown : optional;
#toolset.msvc

variant debug : : <optimization> off<debug - symbols> on<inlining>
                    off<runtime - debugging>
                      on;
variant release : : <optimization> speed<debug - symbols> off<inlining>
