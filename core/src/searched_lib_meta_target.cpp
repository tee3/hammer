...
searched_lib_meta_target::searched_lib_meta_target(
  hammer::project* p,
...
main_target*
searched_lib_meta_target::construct_main_target(
  const main_target* owner,
  const feature_set* properties) const
{
  main_target* mt =
    new searched_lib_main_target(this, name(), lib_name_, properties, type());
  return mt;
}
}
