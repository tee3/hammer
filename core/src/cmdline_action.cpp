                             ...
                             const build_environment& environment) const
{
  ...
  if (rsp_builder_.get() != NULL) {
    ...
    unique_ptr<ostream> rsp_stream(environment.create_output_file(
      rsp_file_path.string().c_str(), ios_base::trunc));
...
bool
cmdline_action::run_shell_commands(const std::vector<std::string>& commands,
