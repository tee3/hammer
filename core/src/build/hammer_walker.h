 ...
 * function) via
 * a parser context typedef phammer_walker, which is returned from a call to
 * hammer_walkerNew().
 *
 ...
 *  - void      phammer_walker->requirements_public_tag(phammer_walker)
 ...
 *  - void      phammer_walker->source_public_tag(phammer_walker)
 ...
 */
  ...
  void (*feature_set_arg)(struct hammer_walker_Ctx_struct* ctx,
                          void* args_list);
  ...
  void (*requirements_public_tag)(struct hammer_walker_Ctx_struct* ctx,
                                  char* flag);
  ...
  void (*source_public_tag)(struct hammer_walker_Ctx_struct* ctx, void* sd);
  ...
  void (*sources_decl_rule_invoke)(struct hammer_walker_Ctx_struct* ctx,
                                   void* sources);
  // Delegated rules
