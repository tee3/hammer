 ...
 * phammerParser->source_decl_impl(phammerParser)
 ...
 * phammerParser->path_element(phammerParser)
 *  - hammerParser_target_features_return
 * phammerParser->target_features(phammerParser)
 ...
 */
  ...
  hammerParser_rule_impl_return (*rule_impl)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_rule_args_return (*rule_args)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_maybe_arg_return (*maybe_arg)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_rule_posible_args_return (*rule_posible_args)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_string_list_return (*string_list)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_feature_set_arg_return (*feature_set_arg)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_feature_set_return (*feature_set)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_project_requirements_return (*project_requirements)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_requirements_return (*requirements)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_string_arg_return (*string_arg)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_feature_arg_return (*feature_arg)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_conditional_features_return (*conditional_features)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_condition_return (*condition)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_condition_result_return (*condition_result)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_feature_return (*feature)(struct hammerParser_Ctx_struct* ctx);
  hammerParser_sources_decl_return (*sources_decl)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_sources_decl_impl_return (*sources_decl_impl)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_rule_invoke_return (*rule_invoke)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_source_decl_return (*source_decl)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_source_decl_impl_return (*source_decl_impl)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_public_tag_return (*public_tag)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_target_path_return (*target_path)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_target_name_return (*target_name)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_path_element_return (*path_element)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_target_features_return (*target_features)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_path_slash_return (*path_slash)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_trail_slash_return (*trail_slash)(
    struct hammerParser_Ctx_struct* ctx);
  hammerParser_head_slash_return (*head_slash)(
    struct hammerParser_Ctx_struct* ctx);
  // Delegated rules
