...
void*
hammer_make_string_list()
{
  return new call_resolver_call_arg<std::vector<string>>(
    new std::vector<string>(), true);
}
...
void
hammer_add_feature_argument(void* context,
                            void* args_list,
                            const char* feature_name,
                            const char* feature_value)
{
...
void
hammer_add_string_arg_to_args_list(void* context,
                                   void* args_list,
                                   const char* id)
{
  hammer_walker_context* ctx = static_cast<hammer_walker_context*>(context);
...
void*
hammer_create_feature(void* context,
                      const char* feature_name,
                      const char* feature_value)
{
  hammer_walker_context* ctx = static_cast<hammer_walker_context*>(context);
...
void*
hammer_make_requirements_condition()
{
...
void*
hammer_make_sources_decl_arg(void* s)
{
...
hammer_source_decl_set_target_path(void* context, void* sd, void* tp)
{
  ...
  source_decl->target_path(
    target_path,
    ctx->engine_->get_type_registry().resolve_from_target_name(target_path));
...
{
  static_cast<hammer::feature_set*>(feature_set)
    ->join(static_cast<hammer::feature*>(feature));
}
