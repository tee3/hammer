...
{
   std::auto_ptr<args_list_t> args_list(static_cast<args_list_t*>(args_list_in));
   ...
   std::auto_ptr<call_resolver_call_arg_base> result(ctx->call_resolver_->invoke(rule_name, *args_list));
