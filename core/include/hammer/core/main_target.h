...
public:
  ...
  boost::intrusive_ptr<const hammer::build_node> build_node() const
  {
    return build_node_;
  }
...
protected:
  virtual void add_additional_dependencies(
  ...
  // must be private, but bad design require me to place it here for
  // file_main_target
...
private:
  ...
  build_node_ptr create_intermediate_dir_dependency() const;

  void add_hamfile_dependency(
