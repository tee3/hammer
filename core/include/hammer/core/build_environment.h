...
public:
  ...
  virtual void copy(const location_t& full_source_path,
                    const location_t& full_destination_path) const = 0;
  ...
  // Calculate temp shell file or .vcproj location. Then we calculate include,
  // output input and others relative to this directory.
