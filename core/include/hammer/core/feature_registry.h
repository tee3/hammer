...
public:
  ...
  feature_def& add_feature_def(
    const std::string& name,
    const feature_def::legal_values_t& legal_values =
      feature_def::legal_values_t(),
  ...
  // find definition for complex names such as os-version where version is
  // subfeature
...
private:
  ...
  feature* simply_create_feature(const std::string& name,
